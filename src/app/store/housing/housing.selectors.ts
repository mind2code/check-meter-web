...
export const selectCurrentId = createSelector(
  housingsFeature.selectSelectedId,
  (selectedId) => selectedId,
);

export const selectLoading = createSelector(
  housingsFeature.selectLoading,
  (loading) => loading,
);

export const selectCreating = createSelector(
  housingsFeature.selectCreating,
  (creating) => creating,
);
...
export const selectCurrentPage = createSelector(
  housingsFeature.selectCurrentPage,
  (currentPage) => currentPage,
);

export const selectTotalRecords = createSelector(
  housingsFeature.selectTotalRecords,
